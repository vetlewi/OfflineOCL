...
void Parameter::Set(const std::string& values)
{
    ...
    std::vector<param_t> par_values;
    std::copy(std::istream_iterator<param_t>(ipar), std::istream_iterator<param_t>(),
              std::back_insert_iterator<std::vector<param_t> >(par_values));
